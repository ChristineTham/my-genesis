 ...
 * My Genesis
 *
 * This file adds the header wrapper functions to the My Genesis Theme.
 *
 * @package My_Genesis
 * @author  Chris Tham
 ...
 * @since 1.0.0
 */
function my_genesis_header_hero_start() {
 ...
 * @since 1.0.0
 */
function my_genesis_header_hero_end() {
...
add_action( 'after_setup_theme', 'my_genesis_additional_schema', 11 );
/**
 * Adds attributes for Footer Navigation if Genesis is outputting schema.
 *
 * @since 1.3.0
 */
function my_genesis_additional_schema() {
...
add_action( 'genesis_header', 'my_genesis_header_right_menu', 9 );
/**
 * Adds header-right menu.
 *
 * @since 1.0.0
 */
function my_genesis_header_right_menu() {
	...
	$menu_text = __( 'Menu', 'my-genesis' );
	$hide_text = __( 'Hide Off Screen Menu', 'my-genesis' );
	$menu_args = [
...
add_action( 'genesis_header', 'my_genesis_header_left_widget', 9 );
/**
 * Adds header-right search area to header.
 *
 * @since 1.0.0
 */
function my_genesis_header_left_widget() {
...
add_filter( 'body_class', 'my_genesis_header_menu_body_class' );
/**
 ...
 */
function my_genesis_header_menu_body_class( $classes ) {
...
add_filter( 'body_class', 'my_genesis_no_off_screen_menu_body_class' );
/**
 ...
 * @return array $classes Updated class array.
 */
function my_genesis_no_off_screen_menu_body_class( $classes ) {
...
add_filter( 'genesis_customizer_theme_settings_config', 'my_genesis_remove_customizer_settings' );
/**
 ...
 */
function my_genesis_remove_customizer_settings( $config ) {
 ...
 * @since 1.0.0
 */
function my_genesis_header_style() {
