...
add_action( 'wp_enqueue_scripts', 'my_genesis_custom_gutenberg_css' );
/**
 ...
 * @since 1.1.0
 */
function my_genesis_custom_gutenberg_css() {
...
CSS;
	...
	$css .= my_genesis_inline_font_sizes();
	$css .= my_genesis_inline_color_palette();

	wp_add_inline_style( genesis_get_theme_handle() . '-gutenberg', $css );

}

add_action( 'enqueue_block_editor_assets', 'my_genesis_custom_gutenberg_admin_css' );
/**
 ...
 * @since 1.1.0
 */
function my_genesis_custom_gutenberg_admin_css() {
...
CSS;
	...
	$css .= my_genesis_editor_inline_color_palette();
 ...
 */
function my_genesis_inline_font_sizes() {
 ...
 */
function my_genesis_inline_color_palette() {
 ...
 * @return string The editor colors CSS if `editor-color-palette` theme support was declared.
 */
function my_genesis_editor_inline_color_palette() {
