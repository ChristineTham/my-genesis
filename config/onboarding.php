...
$my_genesis_onboarding_config = [
	'dependencies'     => [
		'plugins' => [
			[
				'name'       => __( 'Atomic Blocks', 'my-genesis' ),
				'slug'       => 'atomic-blocks/atomicblocks.php',
				'public_url' => 'https://atomicblocks.com/',
			],
			[
				'name'       => __( 'WPForms Lite (Third Party)', 'my-genesis' ),
...
if ( get_option( 'fresh_site' ) ) {
	$my_genesis_onboarding_config['content']['sample-post-1'] = [
	...
	$my_genesis_onboarding_config['content']['sample-post-2'] = [
	...
	$my_genesis_onboarding_config['content']['sample-post-3'] = [
	...
	$my_genesis_onboarding_config['content']['sample-post-4'] = [
	...
	$my_genesis_onboarding_config['content']['sample-post-5'] = [
...
return $my_genesis_onboarding_config;
